## Vendored from upstream Kickback (blugart-dev/kickback, branch feat/balance-behaviors,
## MIT, same LICENSE as this addon) ahead of its 0.6.0 release; unchanged apart
## from this header and the dropped @icon line.
